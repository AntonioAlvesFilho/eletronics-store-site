								...
								<div class="homeMain container-xxl">
												<div id="carouselGames" class="carousel slide game-container" data-bs-ride="true">
																<div class="game-mini-container">
																				...
																				<div data-bs-target="#carouselGames" data-bs-slide-to="2" class="game-title" aria-label="Slide 3">The
																								Last
																								of Us
																				</div>
																				<div data-bs-target="#carouselGames" data-bs-slide-to="3" class="game-title" aria-label="Slide 4">Legend
																								of
																								Zelda:
																...
																<div class="carousel-indicators index">
																				...
																				<button type="button" data-bs-target="#carouselGames" data-bs-slide-to="1"
																								aria-label="Slide 2"></button>
																				<button type="button" data-bs-target="#carouselGames" data-bs-slide-to="2"
																								aria-label="Slide 3"></button>
																				<button type="button" data-bs-target="#carouselGames" data-bs-slide-to="3"
												...
												<div id="carouselRecommended" class="carousel slide recommended-container" data-bs-ride="true">
																...
																<div class="carousel-inner ">
																				...
																				<button class="carousel-control-prev hide" type="button" data-bs-target="#carouselRecommended"
																								data-bs-slide="prev">
